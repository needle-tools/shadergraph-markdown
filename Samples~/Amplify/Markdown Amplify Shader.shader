...
Shader "Markdown Amplify Shader"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _InlineTexture_ST;
			float4 _MyColor;
			float4 _MyVectorMetallicSmoothness;
			float4 _Vector1;
			float2 _Vector0;
			int _Header;
			int _NOTEMarkdowninAmplifyShaders;
			float _DRAWERMinMax_Vector1;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_InlineTexture = IN.ase_texcoord7.xy * _InlineTexture_ST.xy + _InlineTexture_ST.zw;
				
				float4 break14 = _MyVectorMetallicSmoothness;
				
				float3 Albedo = ( tex2D( _InlineTexture, uv_InlineTexture ) * _MyColor ).rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = break14.x;
				float Smoothness = break14.y;
				float Occlusion = 1;
				float Alpha = _Vector1.w;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_InlineTexture = IN.ase_texcoord2.xy * _InlineTexture_ST.xy + _InlineTexture_ST.zw;
...
/*ASEBEGIN
Version=18800
184;117;815;790;1011.259;-238.1522;1;True;True
...
Node;AmplifyShaderEditor.Vector2Node;18;-448.927,505.5834;Inherit;False;Property;_Vector0;Vector 0;5;1;[RemapSliders];Create;True;0;0;0;True;0;False;0,0;0.2655356,0.4674557;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector4Node;20;-283.3334,743.4744;Inherit;False;Property;_Vector1;Vector 1;6;1;[RemapSlidersFull];Create;True;0;0;0;True;0;False;0,0,0,0;0.1246695,0.3935832,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;352,141;Float;False;True;-1;2;Needle.MarkdownShaderGUI;0;2;Markdown Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;2;4;14;1
WireConnection;2;6;20;4
ASEEND*/
//CHKSM=F58B2B3CBF1AC83BE61E111F50ACB71C3FEB4479